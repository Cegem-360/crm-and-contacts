{{-- Sales module header with red accent --}}
        ...
        <div class="hidden sm:flex items-center">
            <div class="relative">
                ...
                <input
                    ...
                    class="w-64 pl-10 pr-4 py-2 bg-gray-100 dark:bg-gray-700 border-0 rounded-lg text-sm text-gray-900 dark:text-white placeholder-gray-500 focus:ring-2 focus:ring-red-500 focus:bg-white dark:focus:bg-gray-600 transition"
                >
            </div>
        </div>
    </div>
