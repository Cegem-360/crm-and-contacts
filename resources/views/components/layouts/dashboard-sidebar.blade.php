...
<aside
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-6">
        ...
        {{-- 1. Kampányok --}}
        <x-sidebar-section title="Campaigns">
        ...
        <x-sidebar-section title="Sales">
            ...
            <x-sidebar-item route="dashboard.quote-templates" icon-color="text-blue-400"
        ...
        {{-- 3. Kedvezmények --}}
        <x-sidebar-section title="Discounts">
        ...
        <x-sidebar-section title="Customers">
            ...
            <x-sidebar-item route="dashboard.opportunities" icon-color="text-red-400"
                ...
                {{ __('Leads / Opportunities') }}
            </x-sidebar-item>
            <x-sidebar-item route="dashboard.opportunities.kanban" icon-color="text-red-400"
                icon="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7">
                {{ __('Kanban Board') }}
            </x-sidebar-item>
            <x-sidebar-item route="dashboard.interactions" icon-color="text-red-400"
                icon="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z">
                {{ __('Interactions') }}
            </x-sidebar-item>
            <x-sidebar-item route="dashboard.tasks" icon-color="text-red-400"
                icon="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4">
                {{ __('Tasks') }}
            </x-sidebar-item>
            <x-sidebar-item route="dashboard.chat-sessions" icon-color="text-red-400"
        ...
        {{-- 5. Reklamációk --}}
        <x-sidebar-section title="Complaints">
            <x-sidebar-item route="dashboard.complaints" icon-color="text-yellow-400"
        ...
        <x-sidebar-section title="Products">
            <x-sidebar-item route="dashboard.products" icon-color="text-teal-400"
                icon="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4">
                {{ __('Products') }}
            </x-sidebar-item>
            <x-sidebar-item route="dashboard.product-categories" icon-color="text-teal-400"
