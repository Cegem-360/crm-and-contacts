    ...
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ number_format($totalOpportunities) }}
                    </p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ number_format($openOpportunities) }}
                    </p>
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">
                        {{ number_format($closedOpportunities) }}</p>
