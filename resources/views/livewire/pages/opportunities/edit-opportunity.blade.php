<div>
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-center gap-4">
            <a href="{{ $opportunity?->exists ? route('dashboard.opportunities', ['team' => $currentTeam]) : route('dashboard.opportunities', ['team' => $currentTeam]) }}" class="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition" wire:navigate>
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white font-heading">
                    {{ $opportunity?->exists ? __('Edit Opportunity') : __('New Opportunity') }}
                </h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    {{ $opportunity?->exists ? $opportunity->title : __('Create a new opportunity') }}
                </p>
            </div>
        </div>
    </div>
